...
/* Emphasis: only "মোট X বস্তা" (tfoot-qty) and "বাকী" (tfoot-balance-row) are
   bold; every other tfoot row — ছাড়/খরচ/বিক্রয় মোট/পূর্বের বাকী/সর্বমোট/পরিশোধ —
   is normal weight so the two anchor numbers stand out. */
.tfoot-label  { font-weight: 400; }
.tfoot-amount { font-weight: 400; white-space: nowrap; }
.tfoot-grand-row td { border-top: 1.5px solid #aaa; border-bottom: 1.5px solid #aaa; }
.tfoot-grand  { font-weight: 400; font-size: .94rem; }
.tfoot-balance-row td { background: #fff7ed; font-weight: 700; }
.tfoot-remaining { font-weight: 700; font-size: .98rem; color: #b91c1c; }
...
@media print {
    ...
    .memo-phones-right { font-size: .92rem !important; line-height: 1.3 !important; }   /* owner wants these prominent — safe to enlarge: absolutely positioned top-right, out of flow, doesn't touch the item-table measurements */
