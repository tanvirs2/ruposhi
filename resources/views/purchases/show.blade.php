...
<div class="invoice-card" id="purchaseInvoice">
    <div class="invoice-header">
        <div>
            ...
            <p style="color:#334155;margin-top:4px">তারিখ: {{ $purchase->purchase_date->format('d F Y') }} - {{ $purchase->created_at->format('h:i:sa') }}</p>
        </div>
    ...
    <div class="form-actions no-print" style="margin-top:20px">
        ...
        @else
            ...
            @else
            <form method="POST" action="{{ route('purchases.request-delete', $purchase) }}" style="margin-left:auto"
