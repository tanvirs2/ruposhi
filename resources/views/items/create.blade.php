    ...
    <form method="POST" action="{{ route('items.store') }}">
        ...
        <div class="form-grid">
            ...
            <div class="form-group-field">
                ...
                <select name="unit_type_id" class="form-select">
                    ...
                    @foreach($unitTypes as $ut)
                        <option value="{{ $ut->id }}" @selected(old('unit_type_id') == $ut->id)>{{ $ut->name }}{{ $ut->short ? ' ('.$ut->short.')' : '' }}</option>
                    @endforeach
                </select>
            </div>
            ...
            <div class="form-group-field">
                ...
                <input type="text" inputmode="decimal" name="sale_price" value="{{ old('sale_price', 0) }}" required>
            </div>

            <div class="form-group-field">
                <label>সর্বনিম্ন স্টক (সতর্কতার জন্য)
                    <button type="button" class="info-btn" data-info="স্টক এই পরিমাণের নিচে নামলে 'স্টক কম' সতর্কতা দেখাবে। ডিফল্ট ৫। আপনার ব্যবসার চাহিদা অনুযায়ী সেট করুন।">i</button>
                </label>
